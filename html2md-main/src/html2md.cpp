...
#include "html2md-main/include/table.h"
...
bool Converter::ParseCharInTagContent(char ch) {
  ...
  if (chars_in_curr_line_ > size_t(option.softBreak) && !is_in_table_ && !is_in_list_ &&
      current_tag_ != kTagImg && current_tag_ != kTagAnchor &&
      option.splitLines) {
    if (ch == ' ') { // If the next char is - it will become a list
      md_ += '\n';
      chars_in_curr_line_ = 0;
    } else if (chars_in_curr_line_ > size_t(option.hardBreak)) {
...
void Converter::TagBreak::OnHasLeftClosingTag(Converter *) {}
...
void Converter::TagDiv::OnHasLeftClosingTag(Converter *) {}
...
void Converter::TagOption::OnHasLeftOpeningTag(Converter *) {}
...
void Converter::TagSpan::OnHasLeftOpeningTag(Converter *) {}

void Converter::TagSpan::OnHasLeftClosingTag(Converter *) {}

void Converter::TagTitle::OnHasLeftOpeningTag(Converter *) {}
...
void Converter::TagSeperator::OnHasLeftClosingTag(Converter *) {}
...
void Converter::TagTableRow::OnHasLeftOpeningTag(Converter *) {
