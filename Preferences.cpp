...
void Preferences::setDarkTheme() {
    ...
    darkPalette.setColor(QPalette::Light, QColor(35, 35, 35));
    darkPalette.setColor(QPalette::Mid, QColor(100, 100, 00));
    darkPalette.setColor(QPalette::Dark, Qt::white);
    darkPalette.setColor(QPalette::Button, QColor(53,53,53));
    darkPalette.setColor(QPalette::ButtonText, Qt::white);
    darkPalette.setColor(QPalette::BrightText, Qt::red);
    darkPalette.setColor(QPalette::Highlight, QColor(100,100,100).lighter());
...
void Preferences::setLightTheme() {
    ...
    lightPalette.setColor(QPalette::Mid, QColor(100, 100, 100));
